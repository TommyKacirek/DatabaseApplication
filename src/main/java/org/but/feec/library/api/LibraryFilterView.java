...
public class LibraryFilterView {
    private final LongProperty titleId = new SimpleLongProperty();
    private final StringProperty titleName = new SimpleStringProperty();
    private final LongProperty publicationYear = new SimpleLongProperty();
    private final LongProperty availabilityPresent = new SimpleLongProperty();
    private final LongProperty availabilityAbsent = new SimpleLongProperty();
